...
try {
    ...
    console.log("Connected to the ABROMD Whatsapp Bot By ABRO TECH")
} catch {
...
setTimeout(() => {
    ...
    global.slogo = 'https://imgur.com/7d0iWDc.jpg'
    global.sgc = 'https://wa.me/2348100151048'

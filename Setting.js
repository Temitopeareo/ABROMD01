...
global.owner = process.env.OWNER_NUMBER || '2348100151048' ; // Add Your Number without +
...
global.github = 'https://github.com/Temitopeareo/ABROMD01' ;
...
global.devs = "2348100151048"; //Dont change it From here
global.mztit = process.env.SKTIT ||"🤖ABRO🤖", // add your title here
global.Gname = process.env.GNAME ||"ABRO MD",
global.zyt = process.env.ZYT || '',
global.waUrl = process.env.WAURL ||"SOONN...",
...
module.exports = {
  ...
  packname:  process.env.PACK_NAME || "ABRO-MD" , 
  ...
  caption :process.env.CAPTION || "\t*★ᴘᴏᴡᴇʀᴇᴅ ʙʏ ABRO-MD* ",
  ...
  LANG: process.env.THEME|| 'ABRO_MD',
